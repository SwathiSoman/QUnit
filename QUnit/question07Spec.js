...
QUnit.test('Question Seven', function(assert) {
  assert.ok('MumsPalace.getCakeShopsWithTwoCakes function', function() {
      let theMumsPalace = Controller.setup()
		  QUnit.module("MumsPalace",{
				...
				QUnit.test('theMumsPalace.getCakeShopsWithTwoCakes function', function(assert) {
				...
				QUnit.test('Should return correctly formatted data', function(assert) {
